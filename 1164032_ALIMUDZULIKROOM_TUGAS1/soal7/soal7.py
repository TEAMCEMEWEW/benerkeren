...
w.poly(parts=[[[1,3],[5,3],[1,2],[5,2]]],shapeType=shapefile.POLYLINE) #w untuk write, polyline mendifinisikan membuat polyline dengan (x,y)
w.save("soal7") #menyimpan soal7